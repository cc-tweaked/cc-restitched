...
[![Current build status](https://img.shields.io/github/workflow/status/cc-tweaked/cc-restitched/Build?style=for-the-badge)](https://github.com/cc-tweaked/cc-restitched/actions "Current build status")
