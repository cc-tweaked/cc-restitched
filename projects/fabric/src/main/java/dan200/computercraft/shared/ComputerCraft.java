...
public class ComputerCraft {
    public static void init() {
        ...
        FabricLoader.getInstance().getModContainer(ComputerCraftAPI.MOD_ID).ifPresent(modContainer -> {
            ResourceManagerHelper.registerBuiltinResourcePack(new ResourceLocation(ComputerCraftAPI.MOD_ID, "classic"), modContainer, ResourcePackActivationType.NORMAL);
            ResourceManagerHelper.registerBuiltinResourcePack(new ResourceLocation(ComputerCraftAPI.MOD_ID, "overhaul"), modContainer, ResourcePackActivationType.NORMAL);
        });
    }
