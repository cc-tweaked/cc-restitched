    ...
    public static void addButtons( Screen screen, ClientComputer computer, Consumer<ClickableWidget> add, int x, int y )
    {
        ...
        add.accept( new DynamicImageButton(
            ...
            () -> computer.isOn() ? Arrays.asList(
                ...
                new TranslatableText( "gui.computercraft.tooltip.turn_off.key" ).formatted( Formatting.GRAY )
            ) : Arrays.asList(
        ...
        add.accept( new DynamicImageButton(
            ...
            Arrays.asList(
                ...
                new TranslatableText( "gui.computercraft.tooltip.terminate.key" ).formatted( Formatting.GRAY )
            )
        ) );
    }
