...
public abstract class ItemMapLikeRenderer
{
    ...
    private void renderItemFirstPersonSide( PoseStack transform, MultiBufferSource render, int combinedLight, HumanoidArm side, float equipProgress, float swingProgress, ItemStack stack )
    {
        ...
        if( !minecraft.player.isInvisible() )
        {
            ...
            ((ItemInHandRendererAccess) minecraft.getEntityRenderDispatcher().getItemInHandRenderer()).callRenderPlayerArm( transform, render, combinedLight, equipProgress, swingProgress, side );
            transform.popPose();
        }
