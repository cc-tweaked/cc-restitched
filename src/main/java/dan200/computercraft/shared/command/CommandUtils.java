...
public final class CommandUtils
{
    ...
    public static CompletableFuture<Suggestions> suggestOnServer( CommandContext<?> context, Function<CommandContext<ServerCommandSource>, CompletableFuture<Suggestions>> supplier )
    {
